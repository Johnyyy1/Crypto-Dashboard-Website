...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setIsLoading(true);
      // Mock registration - In a real app you would connect to your backend
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center p-6">
      ...
      {/* Decorative blobs */}
      <div className="absolute top-1/4 right-0 h-96 w-96 rounded-full bg-gradient-to-r from-blue-200 to-emerald-100 blur-3xl opacity-30"></div>
      <div className="absolute bottom-0 left-1/3 h-80 w-80 rounded-full bg-gradient-to-r from-violet-200 to-blue-100 blur-3xl opacity-20"></div>
